...
- Les actions message ne mutent que les `scout_messages.id` explicitement validés par le serveur ; `scout_action_events` trace le `message_id`, le canal et les IDs approuvés.
