...
- DNC hard gate côté qualité TS, côté worker offline, côté provider réel avant génération d'outreach et côté DB pour empêcher un message non bloqué sur une cible DNC ou un outcome négatif ; un DNC ajouté/importé bloque aussi les messages existants liés à l'email, au contact, au domaine ou à l'entreprise.
